...
function AdminLoginPage({ onAdminLogin }) {
  ...
  return (
    <section className="admin-login-bg flex min-h-screen items-center justify-center px-2 py-10">
      <div className="w-full max-w-md rounded-3xl bg-white/90 shadow-2xl border border-slate-200 p-10">
        <div className="mb-8 text-center">
          <span className="section-heading text-accent font-semibold tracking-widest uppercase">Admin Login</span>
          <h1 className="mt-3 text-3xl font-bold text-slate-900">Welcome Back, Admin</h1>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none focus:border-accent focus:ring-2 focus:ring-accent/30 transition"
            />
          </div>
          <div>
