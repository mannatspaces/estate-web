  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-14">
      <div className="rounded-[32px] border border-white/10 bg-white/5 p-10 shadow-glass">
        ...
        <h1 className="mt-4 text-4xl font-bold text-slate-900">Building the future of luxury property discovery.</h1>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-[28px] border border-white/10 bg-white p-6">
            <h2 className="text-xl font-semibold text-slate-900">Curated Portfolio</h2>
            <p className="mt-3 text-slate-600">Exclusive high-end residential, commercial and investment properties.</p>
          </div>
          <div className="rounded-[28px] border border-white/10 bg-white p-6">
            <h2 className="text-xl font-semibold text-slate-900">Seamless Search</h2>
            <p className="mt-3 text-slate-600">Filter by budget, location, type and instantly see updated listings.</p>
          </div>
          <div className="rounded-[28px] border border-white/10 bg-white p-6">
            <h2 className="text-xl font-semibold text-slate-900">Trusted Agents</h2>
