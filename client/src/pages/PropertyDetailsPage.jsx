...
function PropertyDetailsPage({ properties, favorites, toggleFavorite }) {
  ...
  if (!property) {
    return (
      <section className="mx-auto max-w-6xl px-6 py-20 text-center text-slate-400">
    ...
    <section className="mx-auto max-w-7xl px-6 py-10">
      <div className="grid gap-10 lg:grid-cols-[1.4fr_0.9fr]">
        <div className="space-y-8">
          <div className="rounded-2xl border border-slate-700 bg-slate-950 p-6 shadow-glass">
            <div className="relative overflow-hidden rounded-xl">
              ...
              <button
                ...
                className="absolute right-6 top-6 rounded-full bg-slate-950 p-3 text-white transition hover:bg-slate-900"
              >
            ...
            <div className="mt-6 flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-3 text-slate-400">{property.neighborhood} • {property.location}</p>
              </div>
              <div className="rounded-xl bg-slate-950 p-5 text-right">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
            <div className="glass-panel rounded-2xl p-8">
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                <div className="rounded-xl bg-slate-950/75 p-5">
              ...
              <div className="mt-6 text-slate-400">{property.description}</div>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-8">
              ...
              <button className="mt-6 w-full rounded-xl bg-accent px-5 py-4 font-semibold text-slate-950 transition hover:bg-accent2">
                Request Site Visit
              </button>
            </div>
          </div>
          ...
          <div className="glass-panel rounded-2xl p-8">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {(property.gallery || []).map((src) => (
                <img key={src} src={src} alt={property.title} className="h-64 w-full rounded-xl object-cover" />
              ))}
            </div>
          </div>
        ...
        <aside className="space-y-6">
          <div className="glass-panel rounded-2xl p-8">
            ...
            <ul className="mt-6 space-y-4 text-slate-400">
              <li className="rounded-xl bg-slate-950/75 p-4">
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-950 p-8 shadow-glass">
            <span className="section-heading">Need help?</span>
            <p className="mt-4 text-slate-400">Connect with an expert agent for personalized recommendations and financing support.</p>
            <Link to="/contact" className="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-accent px-5 py-4 text-sm font-semibold text-slate-950 hover:bg-accent2">
              Contact Agent
            </Link>
          </div>
        </aside>
